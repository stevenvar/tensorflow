...
// the input.
#define XLA_MAKE_BINARY(NAME, HLO, SYMBOLIC_HLO)                           \
  class NAME##Op : public XlaBinaryOp {                                    \
   public:                                                                 \
    ...
    xla::DynExpr* SymbolicComputation(xla::DynExpr* lhs,                   \
                                      xla::DynExpr* rhs) override {        \
      return SYMBOLIC_HLO;                                                 \
    }                                                                      \
  };                                                                       \
...
XLA_MAKE_BINARY(Atan2, xla::Atan2(lhs, rhs, extend_dimensions), nullptr);
XLA_MAKE_BINARY(Complex, xla::Complex(lhs, rhs, extend_dimensions), nullptr);
...
XLA_MAKE_BINARY(Xlogy, XlogyImpl(lhs, rhs, broadcast_helper), nullptr);
...
XLA_MAKE_BINARY(Xlog1py, Xlog1pyImpl(lhs, rhs, broadcast_helper), nullptr);
...
XLA_MAKE_BINARY(Xdivy, XdivyImpl(lhs, rhs, broadcast_helper), nullptr);
...
XLA_MAKE_BINARY(BitwiseAnd, xla::And(lhs, rhs, extend_dimensions), nullptr);
XLA_MAKE_BINARY(BitwiseOr, xla::Or(lhs, rhs, extend_dimensions), nullptr);
XLA_MAKE_BINARY(BitwiseXor, xla::Xor(lhs, rhs, extend_dimensions), nullptr);
...
XLA_MAKE_BINARY(LogicalAnd, xla::And(lhs, rhs, extend_dimensions), nullptr);
XLA_MAKE_BINARY(LogicalOr, xla::Or(lhs, rhs, extend_dimensions), nullptr);
XLA_MAKE_BINARY(Mod, xla::Rem(lhs, rhs, extend_dimensions), nullptr);
XLA_MAKE_BINARY(Maximum, xla::Max(lhs, rhs, extend_dimensions), nullptr);
XLA_MAKE_BINARY(Minimum, xla::Min(lhs, rhs, extend_dimensions), nullptr);
...
XLA_MAKE_BINARY(TruncateDiv,
                ...
                (*lhs / *rhs)->s());
XLA_MAKE_BINARY(TruncateMod, xla::Rem(lhs, rhs, extend_dimensions), nullptr);

// Comparison ops
XLA_MAKE_BINARY(Equal, xla::Eq(lhs, rhs, extend_dimensions), nullptr);
XLA_MAKE_BINARY(NotEqual, xla::Ne(lhs, rhs, extend_dimensions), nullptr);
XLA_MAKE_BINARY(Greater, xla::Gt(lhs, rhs, extend_dimensions), nullptr);
XLA_MAKE_BINARY(GreaterEqual, xla::Ge(lhs, rhs, extend_dimensions), nullptr);
XLA_MAKE_BINARY(Less, xla::Lt(lhs, rhs, extend_dimensions), nullptr);
XLA_MAKE_BINARY(LessEqual, xla::Le(lhs, rhs, extend_dimensions), nullptr);
...
XLA_MAKE_BINARY(SoftplusGrad, xla::Mul(lhs, xla::Logistic(rhs)), nullptr);
...
XLA_MAKE_BINARY(Pow, xla::Pow(lhs, rhs, extend_dimensions), nullptr);
...
XLA_MAKE_BINARY(Igamma, IgammaImpl(lhs, rhs, broadcast_helper), nullptr);
...
XLA_MAKE_BINARY(RandomGammaGrad,
                RandomGammaGradImpl(lhs, rhs, broadcast_helper), nullptr);
...
XLA_MAKE_BINARY(Igammac, IgammacImpl(lhs, rhs, broadcast_helper), nullptr);
...
XLA_MAKE_BINARY(Polygamma, PolygammaImpl(lhs, rhs, broadcast_helper), nullptr);
...
XLA_MAKE_BINARY(Zeta, ZetaImpl(lhs, rhs, broadcast_helper), nullptr);
